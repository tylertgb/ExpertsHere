...
//************START OF MAKE A REQUEST Btn POP UP BOX FUNCTIONING */
var popUp = document.querySelector("#popUp"),
  showRequestBox = popUp.querySelector("#showRequestBox"),
  closeBtn = popUp.querySelectorAll("#closeBtn");

//**Showing the Pop up box on click */
showRequestBox.addEventListener("click", () =>{
...
//************END OF MAKE A REQUEST Btn POP UP BOX FUNCTIONING */
